...
upButton :: Purview parentAction action m
upButton = onClick ("up" :: String) $ div [ text "up" ]

downButton :: Purview parentAction action m
downButton = onClick ("down" :: String) $ div [ text "down" ]

handler :: Applicative m => (Int -> Purview parentAction action m) -> Purview parentAction action m
...
component :: Applicative m => Purview parentAction action m
